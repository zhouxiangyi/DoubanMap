...
| type | Type:`String`<br>If property is present, must be one of the following values: <ul><li>`classedColor`</li><li>`classedSize`</li><li>`dotDensity`</li><li>`predominance`</li><li>`relationship`</li><li>`univariateColorSize`</li></ul>
